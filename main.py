...
from plot_func import plot_residuals, plot_scatter, plot_scatter_cum, plot_ts, plot_ts_giovanni2, plot_ts_giovanni1, plot_ts_climatologia
...
if __name__ == "__main__":
    ...
    plot_ts_climatologia(all_var, 'all')
    # plot_ts(all_var, 'all')
